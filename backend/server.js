...
import {
  startSalesSync,
} from "./modules/projects/salesSync.job.js";
...
const server = app.listen(
  ...
  () => {
    ...
    console.log(
      `📋 Tasks API: ${API_V1}/tasks`
    );

    console.log(
      `📊 Reports API: ${API_V1}/reports`
    );

    console.log(
      `⏰ Reminders API: ${API_V1}/reminders`
    );

    console.log(
      `❤️ Health Check: ${API_V1}/health`
    );
  }
);
