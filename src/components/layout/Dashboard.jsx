  ...
  return (
    <div className="ml-5">
      <div className="cursor-pointer p-4">
        <span className="font-medium text-[14px]/[20px] text-[#949494]">
          Home
        </span>{" "}
      ...
      <div className="flex flex-col gap-2 relative">
        <div className="border-b-[1.5px] border-[#0000000D] px-4 pb-4">
          <h3 className="font-semibold text-[14px]/[20px] text-[#090909] mb-2">
            Dashboard
          </h3>
          <p className="font-normal text-[14px]/[20px] text-[#636363] mb-3">
            Here's an overview of all activities
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <div
              className="w-full h-35.75 rounded-lg p-3 flex flex-col justify-between"
              style={statCardBackgroundStyle}
            >
              <div className="flex justify-between">
                <div>
                  <p className="font-semibold text-[16px]/[20px] text-[#090909] mb-2">
                    {projects.length}
                  </p>
              ...
              <div className="flex items-center justify-between">
                <p className="font-medium text-[14px]/[20px] text-[#1B3C4A] cursor-pointer">
                  See Details
                </p>
                <ChevronIcon />
              </div>
        ...
        <div className="p-4 flex flex-col">
          <div className="flex justify-between">
            ...
            <button
              ...
              className="rounded-md border border-[#0000000D] py-2.5 px-4 font-medium text-[14px]/[20px] text-[#1B3C4A] cursor-pointer hover:border-[#1B3C4A] flex items-center gap-2"
            >
              See All <ChevronIcon />
            </button>
          </div>
            ...
            <section className="w-full min-h-0 overflow-auto no-scrollbar rounded-lg border border-[#0000000D] relative mt-6">
              <table className="min-w-300 border-collapse whitespace-nowrap">
                <thead className="sticky top-0 z-20 h-11 bg-[#F9FAFB]">
                  <tr className="">
                    <th className="px-4 py-3 font-semibold text-[12px]/[18px] text-[#090909] text-left">
                      ID
                    </th>
                    <th className="px-4 py-3 font-semibold text-[12px]/[18px] text-[#090909] text-left">
                      Project Name
                    ...
                    <th className="px-4 py-3 font-semibold text-[12px]/[18px] text-[#090909] text-center">
                      Status
                    </th>
                    <th className="px-4 py-3 font-semibold text-[12px]/[18px] text-[#090909] text-center">
                      Stage
                ...
                <tbody className="h-11">
                  {activeProjects.map((project, index) => (
                    ...
                    >
                      <td className="px-4 py-4 font-normal text-[14px]/[20px] text-[#636363] overflow-hidden whitespace-nowrap text-ellipsis">
                        {project.projectId}
                      </td>
                      <td
                        title={project.projectName}
                        className="px-4 py-4 font-normal text-[14px]/[20px] text-[#636363] overflow-hidden whitespace-nowrap text-ellipsis"
                      >
                        {project.projectName}
                      </td>
                      <td
                      ...
                      {user?.role === "HEADOFOPS" && (
                        <td
                          ...
                          className="px-4 py-4 font-normal text-[14px]/[20px] text-[#636363]"
                        >
                      ...
                      {/* <td className="px-4 py-4 font-normal text-[14px]/[20px] text-[#636363] relative">
                        ...
                        {openProjectMenu === project.projectId && (
                          <div className="max-h-40 overflow-y-auto no-scrollbar absolute z-1000 w-40 right-5 border border-[#0000000D] bg-[#F9FAFB] rounded-lg text-[14px]/[20px]">
                            <ul>
            ...
            <div className="w-full max-w-88 flex flex-col items-center gap-6">
              <div className="flex flex-col items-center gap-4">
                <div className="w-39.5 h-25.25 relative">
                  <div className="w-34 flex flex-col gap-2.5 absolute left-2.75 top-0">
                    {[0, 1].map((i) => (
                      <div
                        key={i}
                        className="w-34 h-11.5 rounded-lg border border-[#0000000D] bg-[#F3F3F3] flex items-center gap-1.5 px-1.75 relative"
                      >
                ...
                <div className="flex flex-col items-center gap-1">
                  <h2 className="font-medium text-[16px]/[24px] text-[#090909] text-center">
                    No projects assigned
                  </h2>
                  <p className="font-normal text-[14px]/[20px] text-[#636363] text-center">
