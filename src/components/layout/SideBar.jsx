...
function SideBar({
  ...
  return (
    <>
      ...
      <div
        className={
          "w-70 lg:w-[19.44%] h-screen bg-[#FFFFFF] pb-4 fixed top-0 left-0 flex flex-col border-r-[1.5px] border-[#0000000D] z-2000 transition-transform duration-300 lg:translate-x-0 " +
          (isSidebarOpen ? "translate-x-0" : "-translate-x-full")
        }
      >
        <div className="flex items-center gap-3 border-b-[1.5px] border-[#0000000D] p-4 h-18">
          <img src={FasylLogo} alt="Fasyl Logo" className="w-10 h-10" />
          <div>
        ...
        <div className="flex flex-col items-start justify-between p-4 pb-4 h-full">
          ...
          >
            <LogoutIcon />
            <p className="py-2 px-3 font-medium text-[16px]/[24px] text-[#D20019] mt-auto">
              Logout
            </p>
          </div>
        </div>
