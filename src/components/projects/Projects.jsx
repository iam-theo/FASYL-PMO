  ...
  if (isLoading)
    return (
      <div className="w-full h-screen flex items-center justify-center">
        <div
          className={`w-18 h-18 rounded-full border-8 border-[#636363] border-t-[#1B3C4A] absolute top-50 animate-spin`}
        ></div>
      </div>
    );

  return (
    <div className="ml-5 px-4 pt-4 flex flex-col h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 relative">
        ...
        <div className="w-full sm:w-102.25 h-10 flex items-center gap-3 relative">
          <div className="flex-1 sm:w-72.25 border border-[#00000026] py-2.5 px-3 bg-[#FFFFFF] rounded-lg flex items-center gap-3">
          ...
          <div className="shrink-0 sm:w-30 rounded-lg border border-[#0000000D] bg-[#E8E8E8] text-[#1B3C4A] py-2.5 px-2 cursor-pointer font-semibold text-[13px]">
            <select
              value={filterValue}
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 w-full py-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-md border border-[#0000000D] shadow-[2px] shadow-[#1018280D] py-2.25 px-4.25 bg-[#E8E8E8] hover:bg-[#1B3C4A] font-medium text-[14px]/[20px] text-[#1B3C4A] hover:text-[#FFFFFF] cursor-pointer"
          >
            Previous
          </button>
          <button
            onClick={() =>
              setCurrentPage((p) =>
                p < Math.ceil(projects.length / itemsPerPage) ? p + 1 : p,
              )
            }
            className="rounded-md border border-[#0000000D] shadow-[2px] shadow-[#1018280D] py-2.25 px-4.25 bg-[#E8E8E8] hover:bg-[#1B3C4A] font-medium text-[14px]/[20px] text-[#1B3C4A] hover:text-[#FFFFFF] cursor-pointer"
          >
