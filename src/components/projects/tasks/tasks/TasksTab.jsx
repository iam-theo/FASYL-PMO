...
function TasksTab({
  ...
  const assigneeOptions = useMemo(() => {
    const members = [...resources, ...tasks.map((t) => t.assignedTo)].filter(
      Boolean,
    );

    const unique = members.filter(
      (member, index, self) =>
        index === self.findIndex((m) => m.recordId === member.recordId),
    );
  ...
  const toggleSelectAllOnPage = () => {
    if (allOnPageSelected) {
      setSelectedIds((prev) =>
        prev.filter((id) => !paginatedTasks.some((t) => t.id === id)),
      );
    } else {
      setSelectedIds((prev) =>
  ...
  const handleSaveTask = async (taskId, editTask) => {
    try {
      const response = await updateTask(taskId, editTask);
      ...
      <div className="px-4 pt-4 flex flex-col gap-4">
        ...
        {selectedIds.length > 0 && (
          <div className="rounded-lg border border-[#0000000D] bg-[#FFFFFF80] p-4 flex items-center justify-between flex-wrap gap-3">
            <p className="font-medium text-[12px]/[18px] text-[#090909]">
              ...
              <table className="w-full border-collapse min-w-175">
                <thead>
                  <tr className="border-b border-[#0000000D]">
                    ...
                    <th className="px-6 py-4 text-left font-medium text-[12px]/[18px] text-[#636363]">
                      Task
                    </th>
                    <th className="px-6 py-4 text-left font-medium text-[12px]/[18px] text-[#636363]">
                      Assigned To
                    ...
                    <th className="px-6 py-4 text-right font-medium text-[12px]/[18px] text-[#636363]">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {paginatedTasks.length === 0 && (
                    <tr>
                      <td
                        colSpan={7}
                        className="px-6 py-10 text-center font-normal text-[14px]/[20px] text-[#636363]"
                      >
      ...
      <div className="w-full max-w-88 flex flex-col items-center gap-6 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center gap-1">
            <h3 className="font-medium text-[16px]/[24px] text-[#090909]">
...
function ListViewIcon() {
  return (
    ...
    >
      <path
        d="M7.60059 4.1665H17.6006"
        stroke="black"
        strokeWidth="1.25"
        strokeLinecap="round"
      />
      <path
        d="M7.60059 10H17.6006"
        stroke="black"
        strokeWidth="1.25"
        strokeLinecap="round"
      />
      <path
        d="M7.60059 15.8335H17.6006"
        stroke="black"
        strokeWidth="1.25"
        strokeLinecap="round"
      />
      <path
        d="M2.70508 4.16683H2.60091M2.80924 4.16683C2.80924 4.28189 2.71597 4.37516 2.60091 4.37516C2.48585 4.37516 2.39258 4.28189 2.39258 4.16683C2.39258 4.05177 2.48585 3.9585 2.60091 3.9585C2.71597 3.9585 2.80924 4.05177 2.80924 4.16683Z"
        stroke="black"
        strokeWidth="1.25"
        strokeLinecap="round"
      ...
      />
      <path
        d="M2.70508 9.99984H2.60091M2.80924 9.99984C2.80924 10.1149 2.71597 10.2082 2.60091 10.2082C2.48585 10.2082 2.39258 10.1149 2.39258 9.99984C2.39258 9.88475 2.48585 9.7915 2.60091 9.7915C2.71597 9.7915 2.80924 9.88475 2.80924 9.99984Z"
        stroke="black"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M2.70508 15.8333H2.60091M2.80924 15.8333C2.80924 15.9484 2.71597 16.0417 2.60091 16.0417C2.48585 16.0417 2.39258 15.9484 2.39258 15.8333C2.39258 15.7182 2.48585 15.625 2.60091 15.625C2.71597 15.625 2.80924 15.7182 2.80924 15.8333Z"
        stroke="black"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function KanbanViewIcon() {
  return (
    ...
    >
      <path
        d="M16.757 3.24286C17.9163 4.40224 17.9163 6.26821 17.9163 10.0002C17.9163 13.7321 17.9163 15.5981 16.757 16.7575C15.5976 17.9168 13.7316 17.9168 9.99967 17.9168C6.26772 17.9168 4.40175 17.9168 3.24237 16.7575C2.08301 15.5981 2.08301 13.7321 2.08301 10.0002C2.08301 6.26821 2.08301 4.40224 3.24237 3.24286C4.40175 2.0835 6.26772 2.0835 9.99967 2.0835C13.7316 2.0835 15.5976 2.0835 16.757 3.24286Z"
        fill="#C6C6C6"
        fillOpacity="0.8"
        stroke="black"
        strokeWidth="1.25"
